 ...
 *  \file SDL_haptic.h
 *
 *  \brief The SDL haptic subsystem allows you to control haptic (force
 * feedback) devices.
 *
...
typedef struct SDL_HapticConstant {
  ...
  /* Replay */
  Uint32 length; /**< recordFrameWorkDuration of the effect. */
  ...
  /* Envelope */
  Uint16 attack_length; /**< recordFrameWorkDuration of the attack. */
  Uint16 attack_level;  /**< Level at the start of the attack. */
  Uint16 fade_length;   /**< recordFrameWorkDuration of the fade. */
...
typedef struct SDL_HapticLeftRight {
  ...
  /* Replay */
  Uint32 length; /**< recordFrameWorkDuration of the effect in milliseconds. */
 ...
 *  Uint32 length;        // recordFrameWorkDuration of effect (ms).
 ...
 *  Uint16 attack_length; // recordFrameWorkDuration of the attack (ms).
 *  Uint16 attack_level;  // Level at the start of the attack.
 *  Uint16 fade_length;   // recordFrameWorkDuration of the fade out (ms).
 *  Uint16 fade_level;    // Level at the end of the fade.
 *  \endcode
 *
 *
 ...
 */
extern DECLSPEC SDL_Haptic *SDLCALL
 ...
 */
extern DECLSPEC int SDLCALL SDL_HapticRunEffect(SDL_Haptic *haptic, int effect,
                                                Uint32 iterations);
