...
public:
  explicit RetroAchievementsOfflineClient(AchievementService &achievementService)
...
private:
  ...
  handleAchievementSetsRequest(const std::string &username, const std::string &token, const std::string &hash) const;

  [[nodiscard]] rc_api_server_response_t handleStartSessionRequest(const std::string &username, int gameId,
                                                                   bool hardcore) const;
  ...
  [[nodiscard]] rc_api_server_response_t handleLogin2Request(const std::string &username, const std::string &password,
  ...
  void processAchievementSetsResponse(const std::string &username, const std::string &hash,
                                      const std::string &response) const;

  void processStartSessionResponse(const std::string &username, int gameId, const std::string &response) const;

  void processAwardAchievementResponse(const std::string &username, bool hardcore, const std::string &response) const;
