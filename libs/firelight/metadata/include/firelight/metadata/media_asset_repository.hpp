...
namespace firelight::metadata {
  ...
  public:
     ...
     */
    [[nodiscard]] virtual std::vector<MediaAsset>
    listForContent(const std::string &contentHash) = 0;
     ...
     */
    [[nodiscard]] virtual std::vector<MediaAsset>
    listForContentAndType(const std::string &contentHash, MediaType type) = 0;
     ...
     */
    [[nodiscard]] virtual std::optional<MediaAsset>
    selectedFor(const std::string &contentHash, MediaType type) = 0;
