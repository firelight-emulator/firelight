...
class InputService : public libretro::IRetropadProvider, public libretro::IPointerInputProvider {
public:
  ...
  // the override lookup
  virtual void applyGameContext(std::optional<std::string> contentHash, int platformId) = 0;
  ...
  virtual void setSessionPreferredControllerType(int platformId, int gamepadType) {}
