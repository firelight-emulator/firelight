...
public:
  ...
  [[nodiscard]] const std::vector<SettingsPage> &pages() const { return m_pages; }

  [[nodiscard]] const std::vector<SettingsGroup> &groups() const { return m_groups; }
  ...
  [[nodiscard]] const std::vector<SettingDefinition> &appSettings() const { return m_app; }

  [[nodiscard]] const std::vector<SettingDefinition> &commonSettings() const { return m_common; }
