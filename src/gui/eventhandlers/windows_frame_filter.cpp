...
void WindowsFrameFilter::setWindow(QWindow *window) {
  ...
  SetWindowPos(m_hwnd, nullptr, 0, 0, physW, physH + 1, SWP_NOMOVE | SWP_NOZORDER | SWP_NOACTIVATE);
  SetWindowPos(m_hwnd, nullptr, 0, 0, physW, physH, SWP_NOMOVE | SWP_NOZORDER | SWP_NOACTIVATE);
}
...
bool WindowsFrameFilter::nativeEventFilter(const QByteArray &eventType, void *message, qintptr *result) {
...
bool WindowsFrameFilter::nativeEventFilter(const QByteArray &, void *, qintptr *) { return false; }
