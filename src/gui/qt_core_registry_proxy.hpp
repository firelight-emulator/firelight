...
public:
  ...
  Q_INVOKABLE QString resolvedCore(int platformId, const QString &contentHash) const;

  // The core explicitly set at a tier ("" if none / inheriting)
  Q_INVOKABLE QString coreOverride(int level, int platformId, const QString &contentHash) const;

  Q_INVOKABLE void setCoreOverride(int level, int platformId, const QString &contentHash, const QString &coreId);
  Q_INVOKABLE void clearCoreOverride(int level, int platformId, const QString &contentHash);
