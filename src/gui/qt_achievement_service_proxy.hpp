...
class QtAchievementServiceProxy : public QObject {
  ...
  Q_PROPERTY(bool inHardcoreSession READ inHardcoreSession NOTIFY inHardcoreSessionChanged)
  Q_PROPERTY(unsigned numCurrentSessionHardcoreUnlocks READ numCurrentSessionHardcoreUnlocks NOTIFY
                 numCurrentSessionHardcoreUnlocksChanged)
public:
  explicit QtAchievementServiceProxy(achievements::AchievementService &achievementService, QObject *parent = nullptr);
