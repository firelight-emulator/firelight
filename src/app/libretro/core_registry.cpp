...
CoreRegistry::CoreRegistry() {
  ...
  m_cores = {
      {"gambatte_libretro", "Gambatte", {PM::PLATFORM_ID_GAMEBOY, PM::PLATFORM_ID_GAMEBOY_COLOR}},
      ...
      {"mednafen_supergrafx_libretro", "Beetle SuperGrafx", {PM::PLATFORM_ID_TURBOGRAFX16, PM::PLATFORM_ID_SUPERGRAFX}},
      {"pokemini_libretro", "PokeMini", {PM::PLATFORM_ID_POKEMON_MINI}},
      {"mednafen_wswan_libretro", "Beetle WonderSwan", {PM::PLATFORM_ID_WONDERSWAN}},
      {"mednafen_ngp_libretro", "Beetle NeoPop", {PM::PLATFORM_ID_NEOGEO_POCKET}},
