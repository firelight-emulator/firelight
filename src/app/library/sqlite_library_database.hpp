...
namespace firelight::db {
  ...
  public:
    ...
    bool createLibraryContentDirectory(LibraryContentDirectory &directory) override;

    bool updateLibraryContentDirectory(LibraryContentDirectory &directory) override;

    std::vector<LibraryContentDirectory> getAllLibraryContentDirectories() const override;
