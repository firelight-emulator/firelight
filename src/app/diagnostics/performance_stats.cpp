...
void PerformanceStats::reset() {
  ...
  m_snapshot.wakeOvershootMeanMs = 0.0;
  m_snapshot.spinMarginMs = 0.0;
  m_snapshot.frameRate = 0.0;
  m_snapshot.frameTimeMs = 0.0;
  m_snapshot.frameTimeDeviationPercent = 0.0;
  m_snapshot.submitTimeMs = 0.0;
  m_snapshot.submitDeviationPercent = 0.0;
  m_snapshot.bufferSaturationPercent = 0.0;
  m_snapshot.bufferDeviationPercent = 0.0;
  m_snapshot.closeToUnderrunPercent = 0.0;
  m_snapshot.closeToBlockingPercent = 0.0;
  m_snapshot.correctionPercent = 0.0;
  m_submitMeanNs = 0.0;
  m_submitVarianceNs = 0.0;
