...
TEST_F(PlatformServiceTest, PlatformGameboyAdvanceIsCorrect) {
  const auto expected = firelight::platforms::Platform{
      .id = firelight::platforms::PlatformService::PLATFORM_ID_GAMEBOY_ADVANCE,
      ...
      .controllerTypes = {
          {.id = 1,
           ...
           .inputs = {
               ...
               {"D-Pad Left", firelight::input::GamepadInput::DpadLeft},
               {"D-Pad Right", firelight::input::GamepadInput::DpadRight},
               {"Analog Stick Up", firelight::input::GamepadInput::LeftStickUp},
               {"Analog Stick Down",
      ...
      .controllerTypes = {
          {.id = 1,
           ...
           .inputs = {
               ...
               {"D-Pad Left", firelight::input::GamepadInput::DpadLeft},
               {"D-Pad Right", firelight::input::GamepadInput::DpadRight},
               {"Move cursor up", firelight::input::GamepadInput::RightStickUp},
               {"Move cursor down",
